...
const TRIAGE_DATA_MS: Record<string, TriageProblem[]> = {
  "wont-boot": [
    {
      ...
      quickCheck: "Sentuhkan dua pin PWR_SW kat motherboard guna pemutar skru leper untuk test kalau butang casing yang rosak.",
      severity: "critical",
    },
    {
      slug: "fans-spin-briefly",
      ...
      quickCheck: "Cabut wayar USB 3.0 depan dan kabel RGB/SATA. Check kalau ada pin bengkok atau besi bersentuh kat dalam port USB.",
      severity: "critical",
    },
    {
      slug: "no-post-dram-led",
      ...
      quickCheck: "Cabut semua RAM. Pasang sekeping je kat slot nombor 2 (slot A2) dan tekan rapat sampai bunyi 'klik'.",
      severity: "critical",
    },
    {
      slug: "cmos-battery-dead-date-reset",
      ...
      quickCheck: "Tukar bateri bulat CR2032 kat motherboard dengan yang baru (bahagian bertanda + menghadap atas).",
      severity: "warn",
    },
  ],
  "blue-screen": [
  ...
  "driver-issues": [
    ...
    },
    {
      ...
      quickCheck: "Clean install driver guna DDU. Kalau masih sama, cabut graphic card dan cucuk balik kat slot PCIe atas.",
      severity: "critical",
    },
    {
      slug: "usb-hub-power-surge-exceeded",
